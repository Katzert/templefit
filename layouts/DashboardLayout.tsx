...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'daily', icon: <ClipboardList size={18} />, label: 'Registro Diario' },
  { id: 'habits', icon: <CalendarDays size={18} />, label: 'Tracker Hábitos' },
  { id: 'technical', icon: <Microscope size={18} />, label: 'Ficha Técnica' },
  { id: 'audit', icon: <Target size={18} />, label: 'Auditoría Mensual' },
  { id: 'training-log', icon: <Activity size={18} />, label: 'Registro Entrenamiento' },

  { id: 'social-media', icon: <Share2 size={18} />, label: 'Redes Sociales', minRole: 'admin' },
  { id: 'team-ops', icon: <Briefcase size={18} />, label: 'Libro Operativo', minRole: 'instructor' },
