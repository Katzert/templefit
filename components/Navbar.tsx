            ...
            >
              <div className="p-5 flex flex-col space-y-2.5 bg-[#FBF9F5] dark:bg-[#07090E]">
                <Link 
                  ...
                  className="flex items-center min-h-[44px] px-4 py-2.5 rounded-xl text-xs font-bold tracking-[0.15em] uppercase text-slate-900 dark:text-gray-100 hover:bg-black/5 dark:hover:bg-white/5 hover:text-amber-600 dark:hover:text-temple-gold transition-all"
                >
                  Inicio
                </Link>
                <Link 
                  href="/escuadrones" 
                  onClick={() => setIsOpen(false)} 
                  className="flex items-center min-h-[44px] px-4 py-2.5 rounded-xl text-xs font-black tracking-[0.15em] uppercase text-amber-900 dark:text-temple-gold bg-amber-500/15 dark:bg-temple-gold/15 border border-amber-500/30 dark:border-temple-gold/30 hover:bg-amber-500/25 transition-all"
                >
                  Escuadrones & Camp
                </Link>
                <Link 
